...
check_accuracy(df_low_in_sample,df_low_out_sample,nn_low,baseAsset$Low,1)
check_accuracy(df_low_in_sample,df_low_out_sample,nn_low,baseAsset$Low,2)
check_accuracy(df_high_in_sample,df_high_out_sample,nn_high,baseAsset$High,1)
check_accuracy(df_high_in_sample,df_high_out_sample,nn_high,baseAsset$High,2)
check_accuracy(df_open_in_sample,df_open_out_sample,nn_open,baseAsset$Open,1)
check_accuracy(df_open_in_sample,df_open_out_sample,nn_open,baseAsset$Open,2)
check_accuracy(df_close_in_sample,df_close_out_sample,nn_close,baseAsset$Close,1)
check_accuracy(df_close_in_sample,df_close_out_sample,nn_close,baseAsset$Close,2)
check_accuracy(df_ma_in_sample,df_ma_out_sample,nn_ma,na.omit(as.xts(mean_roll_20(baseAsset$Close),order.by = index(baseAsset$Close))),1)
check_accuracy(df_close_in_sample,df_close_out_sample,nn_close,na.omit(as.xts(mean_roll_20(baseAsset$Close),order.by = index(baseAsset$Close))),2)
